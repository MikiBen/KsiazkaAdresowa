...
int main()
{
    ...
    vector<Uzytkownik>uzytkownicy;
    LogowanieUzytkownika logUzytk;
    OdczytPliku odczyt;
    RejestracjaUzytkownika rejestracja;
    int idUzytkownika;
    char wybor;
    ...
    while(1)
    {
        ...
        if (wybor == '1')
        {
            uzytkownicy = odczyt.odczytPlikuUzytkownicy();
            logUzytk.wczytajLogin();
            logUzytk.sprawdzLogin(uzytkownicy);
            idUzytkownika=uzytkownicy[logUzytk.numerUzytkownika].idUzytkownika;
        ...
        {
            uzytkownicy = odczyt.odczytPlikuUzytkownicy();
            rejestracja.rejestracjaUzytkownika(uzytkownicy);
        }
        else if (wybor == '9')
        {
            exit(0);
